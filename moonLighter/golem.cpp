...
HRESULT golem::init(string _objName, tagFloat _pos)
{
	...
	_golem[0] = IMAGEMANAGER->findImage("골렘정면");
	_attackedGolem[0] = IMAGEMANAGER->findImage("정면맞는빨강");
	_attackedGolem[1] = IMAGEMANAGER->findImage("정면맞는하양");
	_golem[1] = IMAGEMANAGER->findImage("골렘왼쪽");
	_attackedGolem[2] = IMAGEMANAGER->findImage("왼쪽맞는빨강");
	_attackedGolem[3] = IMAGEMANAGER->findImage("왼쪽맞는하양");
	_golem[2] = IMAGEMANAGER->findImage("골렘오른쪽");
	_attackedGolem[4] = IMAGEMANAGER->findImage("오른쪽맞는빨강");
	_attackedGolem[5] = IMAGEMANAGER->findImage("오른쪽맞는하양");
	_golem[3] = IMAGEMANAGER->findImage("골렘뒤쪽");
