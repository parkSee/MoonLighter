...
void loadingScene::lejImageLoading()
{
	...
	_loading->loadFrameImage("보스공격이펙트다운오른쪽", "./image/enemy/보스공격이펙트다운오른쪽.bmp", 2112, 192, 11, 1);
	_loading->loadFrameImage("보스공격이펙트다운왼쪽", "./image/enemy/보스공격이펙트다운왼쪽.bmp", 2112, 192, 11, 1);
	_loading->loadFrameImage("보스공격이펙트업왼쪽", "./image/enemy/보스공격이펙트업왼쪽.bmp", 2112, 192, 10, 1);
	_loading->loadFrameImage("보스공격이펙트업오른쪽", "./image/enemy/보스공격이펙트업오른쪽.bmp", 2112, 192, 10, 1);

	_loading->loadFrameImage("보스뒤오른쪽", "./image/enemy/보스뒤오른쪽.bmp", 11520, 384, 30, 1);
	_loading->loadFrameImage("보스뒤오른쪽빨강", "./image/enemy/보스뒤오른쪽빨강.bmp", 11520, 384, 30, 1);
	_loading->loadFrameImage("보스뒤오른쪽하양", "./image/enemy/보스뒤오른쪽하양.bmp", 11520, 384, 30, 1);
	_loading->loadFrameImage("보스뒤왼쪽", "./image/enemy/보스뒤왼쪽.bmp", 11520, 384, 30, 1);
	_loading->loadFrameImage("보스뒤왼쪽빨강", "./image/enemy/보스뒤왼쪽빨강.bmp", 11520, 384, 30, 1);
	_loading->loadFrameImage("보스뒤왼쪽하양", "./image/enemy/보스뒤왼쪽하양.bmp", 11520, 384, 30, 1);

	_loading->loadFrameImage("보스정면왼쪽", "./image/enemy/보스정면왼쪽.bmp", 11520, 384, 30, 1);
	_loading->loadFrameImage("보스정면왼쪽빨강", "./image/enemy/보스정면왼쪽빨강.bmp", 11520, 384, 30, 1);
	_loading->loadFrameImage("보스정면왼쪽하양", "./image/enemy/보스정면왼쪽하양.bmp", 11520, 384, 30, 1);
	_loading->loadFrameImage("보스정면오른쪽", "./image/enemy/보스정면오른쪽.bmp", 11520, 384, 30, 1);
	_loading->loadFrameImage("보스정면오른쪽빨강", "./image/enemy/보스정면오른쪽빨강.bmp", 11520, 384, 30, 1);
	_loading->loadFrameImage("보스정면오른쪽하양", "./image/enemy/보스정면오른쪽하양.bmp", 11520, 384, 30, 1);

	_loading->loadFrameImage("보스생성", "./image/enemy/보스생성.bmp", 14208, 384, 37, 1);
